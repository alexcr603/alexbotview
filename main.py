...
if (__name__ == "__main__"):
    ...
    dns_tool = """
        _                     _                  _             _
  __ _ | |  ___ __  ____   __(_)  ___ __      __| |__    ___  | |_
 / _` || | / _ \\ \/ /\ \ / /| | / _ \\ \ /\ / /| '_ \  / _ \ | __|
| (_| || ||  __/ >  <  \ V / | ||  __/ \ V  V / | |_) || (_) || |_
 \__,_||_| \___|/_/\_\  \_/  |_| \___|  \_/\_/  |_.__/  \___/  \__|
...
"""
    ...
    print(Colorate.Horizontal(Colors.blue_to_white, "[?] Combien de vue voulez vous (0 = Infini) ↓"))
    amount = int(input(""))
    print("")
    print("[i] Envoi de vues...")
    if (amount == 0):
        for _ in iter(int, 1):
            while True:
                if (active_count() <= 5000):
                    print(Colorate.Horizontal(Colors.blue_to_white, f"Vues envoyees: {x}"))
                    x += 1
